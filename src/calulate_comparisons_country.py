...
for level in levels:
    for agg_var in agg_vars:
        ...
        # save
        pickle.dump(summary_co2, open(outputs_filepath + 'summary_co2_country_' + level + '_' + agg_var + '.p', 'wb'))
        ...
        # save
        pickle.dump(mean_co2, open(outputs_filepath + 'mean_co2_country_' + level + '_' + agg_var + '.p', 'wb'))
        ...
        pickle.dump(country_order, open(outputs_filepath + 'country_order_' +  level + '_' + agg_var + '.p', 'wb'))
        ...
        # save
        pickle.dump(data_rmse_pct, open(outputs_filepath + 'rmse_pct_country_' +  level + '_' + agg_var + '.p', 'wb'))
        ...
        # save
        pickle.dump(data_direction, open(outputs_filepath + 'direction_annual_country_' +  level + '_' + agg_var + '.p', 'wb'))
        ...
        for item in ['Total', 'Imports']:
            ...
            reg_fit.to_csv(outputs_filepath + 'regression_country_linearity_AIC_' + item + '_' + level + '.csv')
        ...
        # save
        pickle.dump(regression_results, open(outputs_filepath + 'regression_country_' +  level + '_' + agg_var + '.p', 'wb'))
        pickle.dump(regression_validation, open(outputs_filepath + 'regression_validation_' +  level + '_' + agg_var + '.p', 'wb'))
