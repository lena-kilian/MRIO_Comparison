...
pickle.dump(country_order, open(outputs_filepath + 'country_order_industry_agg_after.p', 'wb'))
...
# save
pickle.dump(data_rmse_pct, open(outputs_filepath + 'rmse_pct_country_industry_agg_after.p', 'wb'))
...
# save
pickle.dump(data_direction, open(outputs_filepath + 'direction_annual_country_industry_agg_after.p', 'wb'))
...
pickle.dump(regression_validation, open(outputs_filepath + 'regression_validation_industry_agg_after.p', 'wb'))
