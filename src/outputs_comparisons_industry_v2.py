...
summary_industry['Aggregation after Footprint Calculation'] = pickle.load(open(outputs_filepath + 'summary_industry_agg_after.p', 'rb'))
summary_industry['Aggregation before Footprint Calculation'] = pickle.load(open(outputs_filepath + 'summary_industry_agg_before.p', 'rb'))
