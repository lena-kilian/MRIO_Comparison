...
# load data
co2_all = pickle.load(open(emissions_filepath + 'Emissions_aggregated_all_agg_construction.p', 'rb'))
...
# save
pickle.dump(summary_industry, open(outputs_filepath + 'summary_industry_agg_construction.p', 'wb'))
...
# save
pickle.dump(corr_all, open(outputs_filepath + 'corr_industry_agg_construction.p', 'wb'))
