...
# Load Data
summary_industry = pickle.load(open(outputs_filepath + 'summary_industry_agg_construction.p', 'rb'))
corr = pickle.load(open(outputs_filepath + 'corr_industry_agg_construction.p', 'rb'))
...
fig.tight_layout()
plt.savefig(plot_filepath + 'histplot_CO2_sector_corr_by_data_GHG_agg_construction.png', dpi=200, bbox_inches='tight')
plt.show() 
...
fig.tight_layout()
plt.savefig(plot_filepath + 'coxplot_correlation_bydata_industry_GHG_agg_construction.png', dpi=200, bbox_inches='tight')
plt.show()
...
for c in range(2):
    ...
    axs[r, c].set_xlabel("Spearman's Rho")
fig.tight_layout()
plt.savefig(plot_filepath + 'scatterplot_CO2_sector_corr_by_data_GHG_agg_construction.png', dpi=200, bbox_inches='tight')
plt.show() 
...
fig.tight_layout()
plt.savefig(plot_filepath + 'pointplot_CO2_global_by_sector_GHG_agg_construction.png', dpi=200, bbox_inches='tight')
plt.show()
...
fig.tight_layout()
plt.savefig(plot_filepath + 'barplot_CO2_global_by_sector_GHG_agg_construction.png', dpi=200, bbox_inches='tight')
plt.show()