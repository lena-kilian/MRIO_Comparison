...
data_dict = {'oecd_figaro':'ICIO, Figaro', 'oecd_exio':'Exiobase, ICIO', 'oecd_gloria':'ICIO, Gloria', 
             'figaro_exio':'Exiobase, Figaro', 'figaro_gloria':'Figaro, Gloria', 'exio_gloria':'Exiobase, Gloria'}
