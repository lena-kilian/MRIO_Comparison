...
ind_dict = {
    ...
    'Administrative, support and other professional and supporting transport services' : 'Professional & supporting transport services',
    'Agriculture, hunting, forestry' : 'Agriculture & forestry',
    'Air transport' : 'Air transport',
    'Basic metals' : 'Basic metals',
    'Chemical, parmaceuticals and botanical products' : 'Chemicals & parmaceuticals',
    ...
    'Food products, beverages and tobacco' : 'Processing of food & beverages',
    'Human health and social work activities' : 'Human health & social work',
    'IT, information, postal, communication services and publishing' : 'IT, communication services & publishing',
    'Land transport and transport via pipelines' : 'Land & pipeline transport',
    'Machinery, computer, electronic, optical equipment, and other machinery and equipment' : 'Machinery & equipment',
    'Manufacturing nec; repair and installation of machinery and equipment' : 'Repair & manufacturing nec',
    'Mining and quarrying, energy producing products' : 'Mining',
    'Motor vehicles, trailers and semi-trailers' : 'Motor vehicles',
    'Other non-metallic mineral products' : 'Other non-metallic minerals',
    'Other service activities' : 'Other services',
    'Other transport equipment' : 'Other transport equipment',
    'Paper products and printing' : 'Paper & printing',
    'Public administration and defence; compulsory social security' : 'Public administration & defence',
    ...
    'Water supply; sewerage, waste management and remediation activities' : 'Water supply & waste management',
...
for agg_var in agg_vars:
    ...
    # save
    pickle.dump(summary_industry, open(outputs_filepath + 'summary_industry_' + agg_var + '.p', 'wb'))
    ...
    # save
    pickle.dump(corr_all, open(outputs_filepath + 'corr_industry_' + agg_var + '.p', 'wb'))
