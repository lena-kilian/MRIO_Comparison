...
ind_dict = {
    ...
    'Administrative, support and other professional and supporting transport services' : 'Administrative, support and other professional and supporting transport services',
    'Agriculture, hunting, forestry' : 'Agriculture, hunting, forestry',
    'Air transport' : 'Air transport',
    'Basic metals' : 'Basic metals',
    'Chemical, parmaceuticals and botanical products' : 'Chemical, parmaceuticals and botanical products',
    ...
    'Food products, beverages and tobacco' : 'Food products, beverages and tobacco',
    'Human health and social work activities' : 'Human health and social work activities',
    'IT, information, postal, communication services and publishing' : 'IT, information, postal, communication services and publishing',
    'Land transport and transport via pipelines' : 'Land transport and transport via pipelines',
    'Machinery, computer, electronic, optical equipment, and other machinery and equipment' : 'Machinery, computer, electronic, optical equipment, and other machinery and equipment',
    ...
    'Mining and quarrying, energy producing products' : 'Mining and quarrying, energy producing products',
    ...
    'Paper products and printing' : 'Paper products and printing',
    ...
    'Textiles, textile products, leather and footwear' : 'Textiles, textile products, leather and footwear',
    ...
    'Wholesale and retail trade; repair of motor vehicles' : 'Wholesale and retail trade; repair of motor vehicles',
